...
todosLosNoTeam :: [Conductor] -> [Conductor]
todosLosNoTeam conductores = filter noEsNingunTeam conductores

noEsNingunTeam :: Conductor -> Bool
noEsNingunTeam conductor = noEsTeamMario conductor && noEsTeamZelda conductor

noEsTeamZelda :: Conductor -> Bool
noEsTeamZelda conductor = not(elem (nombre conductor) universoZelda)

noEsTeamMario :: Conductor -> Bool
noEsTeamMario = not.esTeamMario
